...
package net.miaohy.pb.filter;

import lombok.extern.slf4j.Slf4j;
import net.miaohy.pb.config.shiro.ShiroFilterProperties;
...
public class RequestPathFilter implements Filter {
    ...
    public RequestPathFilter(ShiroFilterProperties.FilterConfig filterConfig) {
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException, ServletException {
        log.info("============================RequestPathFilter doFilter========================================");
        if (!isEnabled) {
